...
CI=1 CONDA_FORGE_DOCKER_RUN_ARGS="-e EXTRA_CB_OPTIONS" EXTRA_CB_OPTIONS="-c $CHANNEL --debug --dirty" python3 build-locally.py $(CHANNEL=$CHANNEL python3 $MAKE_CONFIG_PY)
